...
dependencies {
    ...
    // modLocalRuntime(group = "me.shedaniel", name = "RoughlyEnoughItems-fabric", version = reiVersion) // Disabled: crashes on fluid rendering during CSL migration
    ...
    // modLocalRuntime(group = "maven.modrinth", name = "jade", version = "lwgbRGaY") // Incompatible with 1.21.1
