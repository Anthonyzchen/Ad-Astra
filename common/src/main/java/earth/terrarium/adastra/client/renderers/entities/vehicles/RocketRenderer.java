...
public class RocketRenderer extends EntityRenderer<Rocket> {
    ...
    public static final ResourceLocation TIER_1_TEXTURE = ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID,
            "textures/entity/rocket/tier_1_rocket.png");
    public static final ResourceLocation TIER_2_TEXTURE = ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID,
            "textures/entity/rocket/tier_2_rocket.png");
    public static final ResourceLocation TIER_3_TEXTURE = ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID,
            "textures/entity/rocket/tier_3_rocket.png");
    public static final ResourceLocation TIER_4_TEXTURE = ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID,
            "textures/entity/rocket/tier_4_rocket.png");
    ...
    @Override
    public void render(Rocket entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource buffer,
            int packedLight) {
