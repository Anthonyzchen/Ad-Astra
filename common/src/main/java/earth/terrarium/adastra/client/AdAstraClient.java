...
public class AdAstraClient {
        ...
        public static final OverlayRenderer OXYGEN_OVERLAY_RENDERER = new OverlayRenderer(0x4099ccff,
                        () -> AdAstraConfigClient.showOxygenDistributorArea, ModBlocks.OXYGEN_DISTRIBUTOR);
        public static final OverlayRenderer GRAVITY_OVERLAY_RENDERER = new OverlayRenderer(0x40DE2F14,
                        () -> AdAstraConfigClient.showGravityNormalizerArea, ModBlocks.GRAVITY_NORMALIZER);
        ...
        private static void registerBlockEntityRenderers() {
                ClientHooks.registerBlockEntityRenderers(ModBlockEntityTypes.ENERGIZER.get(),
                                c -> new EnergizerBlockEntityRenderer());
                ClientHooks.registerBlockEntityRenderers(ModBlockEntityTypes.GLOBE.get(),
                                c -> new GlobeBlockEntityRenderer());
                ClientHooks.registerBlockEntityRenderers(ModBlockEntityTypes.OXYGEN_DISTRIBUTOR.get(),
                                c -> new OxygenDistributorBlockEntityRenderer());
                ClientHooks.registerBlockEntityRenderers(ModBlockEntityTypes.GRAVITY_NORMALIZER.get(),
                                c -> new GravityNormalizerBlockEntityRenderer());
                ClientHooks.registerBlockEntityRenderers(ModBlockEntityTypes.FLAG.get(),
                                c -> new FlagBlockEntityRenderer());
                ClientHooks.registerBlockEntityRenderers(ModBlockEntityTypes.SLIDING_DOOR.get(),
                                c -> new SlidingDoorBlockEntityRenderer());
        }
        ...
        private static void registerEntityRenderers() {
                ...
                ClientHooks.registerEntityRenderer(ModEntityTypes.TIER_1_ROCKET,
                                c -> new RocketRenderer(c, RocketModel.TIER_1_LAYER, RocketRenderer.TIER_1_TEXTURE));
                ClientHooks.registerEntityRenderer(ModEntityTypes.TIER_2_ROCKET,
                                c -> new RocketRenderer(c, RocketModel.TIER_2_LAYER, RocketRenderer.TIER_2_TEXTURE));
                ClientHooks.registerEntityRenderer(ModEntityTypes.TIER_3_ROCKET,
                                c -> new RocketRenderer(c, RocketModel.TIER_3_LAYER, RocketRenderer.TIER_3_TEXTURE));
                ClientHooks.registerEntityRenderer(ModEntityTypes.TIER_4_ROCKET,
                                c -> new RocketRenderer(c, RocketModel.TIER_4_LAYER, RocketRenderer.TIER_4_TEXTURE));
                ClientHooks.registerEntityRenderer(ModEntityTypes.LANDER,
                                c -> new LanderRenderer(c, LanderModel.LAYER));
                ...
                ClientHooks.registerEntityRenderer(ModEntityTypes.LUNARIAN_WANDERING_TRADER,
                                LunarianWanderingTraderRenderer::new);
        ...
        public static void registerArmor() {
                ClientPlatformUtils.registerArmor(SpaceSuitModel.SPACE_SUIT_TEXTURE, SpaceSuitModel.SPACE_SUIT_LAYER,
                                SpaceSuitModel::new,
                                ModItems.SPACE_HELMET.get(), ModItems.SPACE_SUIT.get(),
                                ModItems.SPACE_PANTS.get(), ModItems.SPACE_BOOTS.get());
                ClientPlatformUtils.registerArmor(SpaceSuitModel.NETHERITE_SPACE_SUIT_TEXTURE,
                                SpaceSuitModel.NETHERITE_SPACE_SUIT_LAYER, SpaceSuitModel::new,
                ...
                ClientPlatformUtils.registerArmor(SpaceSuitModel.JET_SUIT_TEXTURE, SpaceSuitModel.JET_SUIT_LAYER,
                                SpaceSuitModel::new,
        ...
        private static void registerItemProperties() {
                ClientHooks.registerItemProperty(ModItems.ETRIONIC_CAPACITOR.get(),
                                ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "toggled"),
                                (stack, level, entity, i) -> EtrionicCapacitorItem.active(stack) ? 0 : 1);
        }
        ...
        public static void onRegisterParticles(
                        BiConsumer<ParticleType<SimpleParticleType>, ClientPlatformUtils.SpriteParticleRegistration<SimpleParticleType>> consumer) {
        ...
        public static void onRegisterModels(Consumer<ResourceLocation> consumer) {
                ModBlocks.GLOBES.stream().forEach(b -> consumer.accept(
                                ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID,
                                                "block/%s_cube".formatted(b.getId().getPath()))));
                consumer.accept(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID,
                                "block/%s_flipped".formatted(ModBlocks.AIRLOCK.getId().getPath())));
                consumer.accept(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID,
                                "block/%s_flipped".formatted(ModBlocks.REINFORCED_DOOR.getId().getPath())));
        ...
        public static void onRegisterItemRenderers(BiConsumer<Item, BlockEntityWithoutLevelRenderer> consumer) {
                ModItems.GLOBES.stream()
                                .forEach(item -> consumer.accept(item.get(),
                                                new GlobeBlockEntityRenderer.ItemRenderer()));
                consumer.accept(ModItems.OXYGEN_DISTRIBUTOR.get(),
                                new OxygenDistributorBlockEntityRenderer.ItemRenderer());
                consumer.accept(ModItems.GRAVITY_NORMALIZER.get(),
                                new GravityNormalizerBlockEntityRenderer.ItemRenderer());
                consumer.accept(ModItems.ROVER.get(), new RoverRenderer.ItemRenderer());
                consumer.accept(ModItems.TIER_1_ROCKET.get(),
                                new RocketRenderer.ItemRenderer(RocketModel.TIER_1_LAYER,
                                                RocketRenderer.TIER_1_TEXTURE));
                consumer.accept(ModItems.TIER_2_ROCKET.get(),
                                new RocketRenderer.ItemRenderer(RocketModel.TIER_2_LAYER,
                                                RocketRenderer.TIER_2_TEXTURE));
                consumer.accept(ModItems.TIER_3_ROCKET.get(),
                                new RocketRenderer.ItemRenderer(RocketModel.TIER_3_LAYER,
                                                RocketRenderer.TIER_3_TEXTURE));
                consumer.accept(ModItems.TIER_4_ROCKET.get(),
                                new RocketRenderer.ItemRenderer(RocketModel.TIER_4_LAYER,
                                                RocketRenderer.TIER_4_TEXTURE));
        }
        ...
        public static void onAddItemColors(BiConsumer<ItemColor, ItemLike[]> consumer) {
                consumer.accept((stack, i) -> i > 0 ? -1 : ((CustomDyeableArmorItem) stack.getItem()).getColor(stack),
                                new ItemLike[] { ModItems.SPACE_HELMET.get(), ModItems.SPACE_SUIT.get(),
                                                ModItems.SPACE_PANTS.get(),
                                                ModItems.SPACE_BOOTS.get() });
                consumer.accept((stack, i) -> i > 0 ? -1 : ((CustomDyeableArmorItem) stack.getItem()).getColor(stack),
                                new ItemLike[] { ModItems.NETHERITE_SPACE_HELMET.get(),
                                                ModItems.NETHERITE_SPACE_SUIT.get(),
                                                ModItems.NETHERITE_SPACE_PANTS.get(),
                                                ModItems.NETHERITE_SPACE_BOOTS.get() });
                consumer.accept((stack, i) -> i > 0 ? -1 : ((CustomDyeableArmorItem) stack.getItem()).getColor(stack),
                                new ItemLike[] { ModItems.JET_SUIT_HELMET.get(), ModItems.JET_SUIT.get(),
        ...
        public static void onAddReloadListener(BiConsumer<ResourceLocation, PreparableReloadListener> consumer) {
                consumer.accept(ResourceLocation.fromNamespaceAndPath(AdAstra.MOD_ID, "planet_renderers"),
                                new AdAstraPlanetRenderers());
        }
                ...
                if (player.getItemBySlot(EquipmentSlot.CHEST).is(ModItemTags.JET_SUITS)) {
                        ...
                        if (KEY_TOGGLE_SUIT_FLIGHT.consumeClick()) {
                                ...
                                Minecraft.getInstance()
                                                .tell(() -> AdAstra.CONFIGURATOR.saveConfig(AdAstraConfigClient.class));
                                player.displayClientMessage(AdAstraConfigClient.jetSuitEnabled
                                                ? ConstantComponents.SUIT_FLIGHT_ENABLED
                                                : ConstantComponents.SUIT_FLIGHT_DISABLED, true);
                        }
