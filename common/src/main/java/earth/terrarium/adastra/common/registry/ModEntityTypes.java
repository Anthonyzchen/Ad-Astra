...
public class ModEntityTypes {
        ...
        public static final ResourcefulRegistry<EntityType<?>> ENTITY_TYPES = ResourcefulRegistries
                        .create(BuiltInRegistries.ENTITY_TYPE, AdAstra.MOD_ID);
        ...
        public static final RegistryEntry<EntityType<CorruptedLunarian>> CORRUPTED_LUNARIAN = ENTITY_TYPES
                        .register("corrupted_lunarian",
        ...
        public static final RegistryEntry<EntityType<MartianRaptor>> MARTIAN_RAPTOR = ENTITY_TYPES
                        .register("martian_raptor", () -> EntityType.Builder.of(MartianRaptor::new, MobCategory.MONSTER)
                                        .sized(0.75f, 2.0f)
        ...
        public static final RegistryEntry<EntityType<ZombifiedPygro>> ZOMBIFIED_PYGRO = ENTITY_TYPES
                        .register("zombified_pygro",
        ...
        public static final RegistryEntry<EntityType<ZombifiedMogler>> ZOMBIFIED_MOGLER = ENTITY_TYPES
                        .register("zombified_mogler",
                                        () -> EntityType.Builder.of(ZombifiedMogler::new, MobCategory.MONSTER)
                                                        .sized(1.4f, 1.4f)
                                                        .fireImmune()
                                                        .build("zombified_mogler"));

        public static final RegistryEntry<EntityType<LunarianWanderingTrader>> LUNARIAN_WANDERING_TRADER = ENTITY_TYPES
                        .register("lunarian_wandering_trader",
                                        () -> EntityType.Builder.of(LunarianWanderingTrader::new, MobCategory.CREATURE)
                                                        .sized(0.6f, 1.95f)
                                                        .fireImmune()
                                                        .build("lunarian_wandering_trader"));

        public static final RegistryEntry<EntityType<SulfurCreeper>> SULFUR_CREEPER = ENTITY_TYPES
                        .register("sulfur_creeper", () -> EntityType.Builder.of(SulfurCreeper::new, MobCategory.MONSTER)
                                        .sized(0.6f, 1.7f)
        ...
        public static void registerSpawnPlacements() {
                try {
                        Method register = SpawnPlacements.class.getDeclaredMethod("register", EntityType.class,
                                        SpawnPlacementType.class, Heightmap.Types.class,
                                        SpawnPlacements.SpawnPredicate.class);
                        register.setAccessible(true);

                        register.invoke(null, ModEntityTypes.LUNARIAN.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<Lunarian>) Lunarian::checkMobSpawnRules);
                        register.invoke(null, ModEntityTypes.CORRUPTED_LUNARIAN.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<CorruptedLunarian>) CorruptedLunarian::checkMonsterSpawnRules);
                        register.invoke(null, ModEntityTypes.STAR_CRAWLER.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<StarCrawler>) StarCrawler::checkMonsterSpawnRules);
                        register.invoke(null, ModEntityTypes.MARTIAN_RAPTOR.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<MartianRaptor>) MartianRaptor::checkMonsterSpawnRules);
                        register.invoke(null, ModEntityTypes.PYGRO.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<Pygro>) Pygro::checkMonsterSpawnRules);
                        register.invoke(null, ModEntityTypes.ZOMBIFIED_PYGRO.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<ZombifiedPygro>) ZombifiedPygro::checkMonsterSpawnRules);
                        register.invoke(null, ModEntityTypes.PYGRO_BRUTE.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<PygroBrute>) PygroBrute::checkMonsterSpawnRules);
                        register.invoke(null, ModEntityTypes.MOGLER.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<Mogler>) Mogler::checkMobSpawnRules);
                        register.invoke(null, ModEntityTypes.ZOMBIFIED_MOGLER.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<ZombifiedMogler>) ZombifiedMogler::checkMonsterSpawnRules);
                        register.invoke(null, ModEntityTypes.LUNARIAN_WANDERING_TRADER.get(),
                                        SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<LunarianWanderingTrader>) Lunarian::checkMobSpawnRules);
                        register.invoke(null, ModEntityTypes.SULFUR_CREEPER.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<SulfurCreeper>) SulfurCreeper::checkMonsterSpawnRules);
                        register.invoke(null, ModEntityTypes.GLACIAN_RAM.get(), SpawnPlacementTypes.ON_GROUND,
                                        Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                                        (SpawnPlacements.SpawnPredicate<GlacianRam>) GlacianRam::checkMobSpawnRules);
                } catch (Exception e) {
                        e.printStackTrace();
                }
        }
        ...
        public static void registerAttributes(
                        BiConsumer<Supplier<? extends EntityType<? extends LivingEntity>>, Supplier<AttributeSupplier.Builder>> attributes) {
